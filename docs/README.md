...
| Area | Purpose |
| --- | --- |
| `product/` | Vision, scope, MVP acceptance criteria, and Linear-ready delivery backlog. |
| `architecture/` | Repository map, target boundaries, and architecture decisions. |
| `development/` | Local setup and the Linear-to-GitHub delivery workflow. |
